...
var analysis = startModalShort.concat(highModal,startModal);
    ...
    var chart = new Chart(lineChart11, {
        ...
        data: {
            ...
            datasets: [
                ...
                borderColor: 'rgb(47,79,79)', //darkslategrey
                hoverBackgroundColor: 'red',
                data: modalTrend
            },{
                label: 'Expected by Analysis: Oberreut - Durlach',
               
                borderColor: 'rgb(178,34,34)', //red
                hoverBackgroundColor: '#00394A',
                data: analysis
            }
    ...
    var chart = new Chart(lineChart12, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: 'rgb(47,79,79)', //darkslatelgrey
                hoverBackgroundColor: 'red',
                data: modalTrend2
            },{
                label: 'Expected by Analysis: Oberreut - Durlach',
